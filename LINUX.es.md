...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [български](LINUX.bg.md), [中文](LINUX.zh-CN.md), [العربية](LINUX.ar.md), [português](LINUX.pt.md), [русский](LINUX.ru.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [esperanto](LINUX.eo.md)</span>
...
Abrir documento `/usr/share/X11/xkb/rules/evdev.xml` e inserte el siguiente bloque de texto después de `Bulgarian (enhanced)` variant.
