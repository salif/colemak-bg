...
**3.** Abrir documento `/usr/share/X11/xkb/rules/evdev.xml` e inserte el siguiente bloque de texto después de la variante `Bulgarian (enhanced)`:
...
**4.** Luego añade `Bulgarian (Colemak)` a través de la configuración de su entorno de escritorio.
